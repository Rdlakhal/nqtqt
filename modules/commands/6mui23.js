...
"https://i.imgur.com/aV4WVsq.jpg"
     ...
     var callback = () => api.sendMessage({body:`حاول ان لا تصبح شاذ بعد رؤية الصور، على مهلكن يا فتيات 🏋️💗`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
