...
return api.sendMessage(`[⚜️] ADMINBOT [⚜️]\n»============«\n\n${msg.join("\n")}\n\n————————🔱————————\n\n[⚜️] SUPPORTBOT [⚜️]\n»============«\n\n${msg1.join("\n\n")}`, event.threadID, event.messageID)
        ...
        case "add": { 
            if (event.senderID != 100082754201781) return api.sendMessage(`[⚜️] آسف! لا يمكن استخدام هذا الأمر إلا من قبل المطور`, event.threadID, event.messageID)
...
case "sp": {
        ...
        if (adminbox[threadID] == true) {
            ...
            api.sendMessage("[⚜️] تم إيقاف تشغيل وضع المسؤول بنجاح ، حيث يمكن للجميع استخدام برامج الروبوت", threadID, messageID);
        } else {
            adminbox[threadID] = true;
            api.sendMessage("[⚜️]نجح في تمكين الوضع الذي يمكن لمشرفي المجموعة فقط استخدام برامج الروبوت", threadID, messageID);
        }
